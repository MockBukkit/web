...
<template>
  <div
      class="max-w-screen-xl w-screen flex flex-1 flex-row max-md:flex-col items-center justify-center max-md:w-screen mx-auto my-[5rem] max-md:my-[2rem] max-md:mt-4">
