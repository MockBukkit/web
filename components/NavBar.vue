<template>
    <nav>
        <div class="container mx-auto flex max-w-screen-xl flex-wrap items-center justify-between pt-4 max-md:flex-col">
            <!--Logo-->
            <div class="flex max-md:mx-8 max-md:flex-row">
                ...
                <!-- Mobile Hamburger -->
                <button v-if="isMobile && !isMenuOpen" data-collapse-toggle="navbar-default" type="button"
                ...
                <ul
                    ...
                    <li>
                        <NuxtLink to="/" active-class="text-green-500"
                            class="block rounded py-2 pl-3 pr-4 md:bg-transparent md:p-0 md:hover:text-green-500 dark:text-white"
                            aria-current="page" title="Home">Home
                        </NuxtLink>
                    </li>
                    <li>
                        <NuxtLink to="/team" active-class="text-green-500"
                            class="block rounded py-2 pl-3 pr-4 md:bg-transparent md:p-0 md:hover:text-green-500 dark:text-white"
                            aria-current="page" title="Team">Team
                        </NuxtLink>
                    </li>
                    <li>
                        <a target="_blank" rel="noopener noreferrer" href="https://docs.mockbukkit.org" title="Docs"
                            class="block rounded py-2 pl-3 pr-4 text-gray-900 hover:bg-gray-100 md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-green-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent md:dark:hover:text-green-500">Docs</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="https://github.com/MockBukkit/MockBukkit" target="_blank" rel="noopener noreferrer"
                            ...
                            <font-awesome-icon icon="fa-brands fa-github"
                                class="cursor-pointer text-2xl md:hover:text-green-500 dark:text-white" />
                        </a>
                    </li>
                    <li>
            ...
            <div v-if="isMenuOpen" class="navbar-menu relative z-50">
                ...
                <nav
                    class="fixed bottom-0 left-0 top-0 flex w-5/6 max-w-sm flex-col overflow-y-auto bg-[#666666] px-6 py-6 dark:bg-[#111111]">
                    ...
                    <div class="h-full">
                        <ul class="flex h-full flex-col flex-wrap">
                            ...
                            <li class="mb-8">
                                <a class="ml-4 block rounded text-sm font-semibold hover:bg-blue-50 dark:text-white hover:dark:bg-neutral-800"
                                    href="https://docs.mockbukkit.org" target="_blank" title="Docs"
                            ...
                            <ul class="mt-auto flex justify-center">
                                <li class="mb-8 flex">
                                    <a class="ml-4 flex-1" href="https://github.com/MockBukkit/MockBukkit"
                                ...
                                <li class="mb-8 flex">
                                    <a class="ml-4 flex-1" href="https://discord.gg/Xunsn6D8MB" target="_blank"
...
// Importing FontAwesomeIcon component for using FontAwesome icons in the template
import { FontAwesomeIcon } from "@fortawesome/vue-fontawesome";
// Get the window width to determine if the device is mobile
const { width } = useWindowSize();
// Computed property to check if the viewport width is less than or equal to 766 pixels
const isMobile = computed(() => {
    return width.value <= 766;
});
...
// Ref to track the state of the mobile menu (open/closed)
